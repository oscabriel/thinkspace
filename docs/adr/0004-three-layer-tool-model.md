...
product thesis of *bespoke* agents. Resolution: "global registry" conflated the
...
1. **Global catalog** — a deliberately *wide* shared palette of vetted first-party
   tools, defined in code. A richer catalog makes agents *more* bespoke-able, not
...
3. **Shape selection** — which permitted tools *this specific agent* uses. A new
...
- Bespoke-ness is enforced *mechanically* by the empty default, not by convention.
