...
_is_ the egress, no host to allowlist) that ADRs 0001/0002 deliberately deferred.
...
Global vs workspace-curatable registry → resolved by **ADR 0004**: global _catalog_,
