...
const bubbleReactionsVariants = cva(
  "absolute z-10 flex w-fit shrink-0 items-center justify-center gap-1 rounded-full bg-muted px-1.5 py-0.5 text-meta ring-2 ring-card has-[button]:p-0",
  {
    defaultVariants: {
      align: "end",
      side: "bottom",
