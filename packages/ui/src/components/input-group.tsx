...
// oxlint-disable jsx-a11y/prefer-tag-over-role, jsx-a11y/click-events-have-key-events, jsx-a11y/no-noninteractive-element-interactions -- vendored shadcn component: role="group" is valid ARIA here, and the addon's onClick only forwards focus to the sibling control (keyboard users Tab to it directly)
